            ...
            GetBuilder<WalletController>(builder: (context) {
              return Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    walletController.walletInfo != null
                        ? CreditCardUi(
                            topLeftColor: gradient.defoultColor,
                            ...
                            balance: double.parse(
                                walletController.walletInfo!.wallet.toString()),
                            validFrom: '',
                            cardType: CardType.other,
                            doesSupportNfc: false,
                            showValidFrom: F,
                            showValidThru: F,
                            cardProviderLogo: Image.asset("assets/180_logo.png"),
                          )
                        : SizedBox.shrink(),
                  ],
                ),
